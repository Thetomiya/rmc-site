        ...
        <section class="section-hero">
            <div class="container p-lg-0">
                ...
                <div class="row pt-3 d-flex justify-content-between align-items-center">
                    ...
                    <textarea class="title-organization col-12 text-center">МИНИСТЕРСТВО ОБРАЗОВАНИЯ АРХАНГЕЛЬСКОЙ ОБЛАСТИ</textarea>
                        <textarea class="title-organization-name col-12 text-center">ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ ДОПОЛНИТЕЛЬНОГО ОБРАЗОВАНИЯ АРХАНГЕЛЬСКОЙ ОБЛАСТИ «ДВОРЕЦ ДЕТСКОГО И ЮНОШЕСКОГО ТВОРЧЕСТВА»</textarea>
                    </div>
